...
void WeaponsResource :: LoadWeaponSprites( WEAPON *pWeapon )
{
	...
	if (p)
	{
		...
		gHR.iHistoryGap = _max( gHR.iHistoryGap, pWeapon->rcActive.bottom - pWeapon->rcActive.top );
	}
	else
		pWeapon->hInactive = 0;
...
int CHudAmmo::VidInit(void)
{
	...
	gHR.iHistoryGap = _max( gHR.iHistoryGap, gHUD.GetSpriteRect(m_HUD_bucket0).bottom - gHUD.GetSpriteRect(m_HUD_bucket0).top);
